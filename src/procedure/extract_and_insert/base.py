...
def extract_entities_from_paper(id_type, id_value, topic, shortenings, db_manager, extract_chain):
    entity_list, relation_triple_list = entity_relation_format(id_type, id_value, topic, db_manager, extract_chain)
    id_dict = {}
    for entity in entity_list:
        entity_shortning = shortenings[entity['type']]
        elementid = add_one_entity(db_manager, id_type, id_value, entity['type'], entity['name'], entity['description'], entity['general'], entity_shortning)
